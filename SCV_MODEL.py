...
def SVCmodel():
    ...
    svc_classifier.fit(dp.x_opt_train,dp.y_train)
    predictions = svc_classifier.predict(dp.x_opt_test)
...
accuracy,MeanAbsoluteError,MeanSquaredError,MedianAbsoluteError,ExplainVarianceScore,R2Score,t1 = SVCmodel()


if __name__== '__SCVMODEL__':
    SVCmodel()
